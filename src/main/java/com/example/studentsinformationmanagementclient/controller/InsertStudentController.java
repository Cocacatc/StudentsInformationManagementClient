...
public class InsertStudentController {
    ...
    void onConfirmAction(ActionEvent event) {
        ...
        if(myGender.equals("未选择")){
            ...
            InsertStudentRequest insertStudentRequest = new InsertStudentRequest(name,number,college,myGender);
            String message = HttpRequestUtil.insertStudent(insertStudentRequest);
            ...
            if(!message.equals("添加成功")){
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("添加失败");
                alert.setContentText("此学号已存在！");
                alert.show();
            }else{
                UserInformation.studentArrayList.add(new Student(6,name,number,myGender,college,new Button(),new Button(),new Button()));
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("添加成功");
    ...
    @FXML
    void initialize() {
        assert Female != null : "fx:id=\"Female\" was not injected: check your FXML file 'insertStudent.fxml'.";
        assert Male != null : "fx:id=\"Male\" was not injected: check your FXML file 'insertStudent.fxml'.";
        assert confirmButton != null : "fx:id=\"confirmButton\" was not injected: check your FXML file 'insertStudent.fxml'.";
        assert nameTextField != null : "fx:id=\"nameTextField\" was not injected: check your FXML file 'insertStudent.fxml'.";
        assert numberTextField != null : "fx:id=\"numberTextField\" was not injected: check your FXML file 'insertStudent.fxml'.";
        assert returnButton != null : "fx:id=\"returnButton\" was not injected: check your FXML file 'insertStudent.fxml'.";
        assert collegeChoiceBox != null : "fx:id=\"collegeChoiceBox\" was not injected: check your FXML file 'insertStudent.fxml'.";
